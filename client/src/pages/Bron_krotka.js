                            ...
                            >
                                {(props) => (
                                    <Form>
                                        ...
                                        <button type="submit" className="btn m-auto mt-4 btn-danger col-4">Akceptuj</button>
                                    </Form>
                                )}
                            </Formik>
                        </div>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a className="dropdown-item active" href="/bron_krotka">Broń krótka</a></li>
...
/*
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" className="btn btn-secondary">Wybierz</button></td>
                                                            ...
                                                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/ASG.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">1. WALTHER P99</h6>
                                        <div className="hline" />
                                        <p>
                                            <a className="btn btn-secondary" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                Więcej
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/rewolwer.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">2. COLT M1911</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample1">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/glock_19x.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">3. GLOCK 19X</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample2">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/beretta.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">4. BERETTA M9/92F</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample3">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/colt_1911.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">5. COLT 1911 (.22LR)</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample4">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/desert_eage.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">6. DESERT EAGLE</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample5">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/sig_sauer.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">7. SIG SAUER P226</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample6">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/colt.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">8. COLT M1911 TACTICAL</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse pb-3" id="collapseExample7">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet samopowtarzalny</h6>
                                                <h6><b>Kaliber:</b> 9x19mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 16</h6>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/cz_shadow.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">9. CZ SHADOW 2</h6>
                                        <div className="hline" />
                                        <p>
