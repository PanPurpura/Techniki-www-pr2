                        ...
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li><a className="dropdown-item active" href="/bron_historyczna">Broń historyczna</a></li>
                                </ul>
                            </li>
                            <li className="nav-item">
                        ...
                        <div className="row row-cols-1 row-cols-lg-3 row-cols-sm-2 g-5 py-5 text-center justify-content-center">
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/kar98k.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">1. AK-47 "KAŁASZNIKOW"</h6>
                                        <div className="hline" />
                                        <p>
                                        ...
                                        <div className="collapse" id="collapseExample">
                                            <div className="card card-body">
                                                <h6><b>Typ:</b> Pistolet maszynowy</h6>
                                                <h6><b>Kaliber:</b> 7,62×25 mm</h6>
                                                <h6><b>Pojemność magazynka:</b> 71/35</h6>
                                                <h6><b>Waga: </b> 3.5 kg</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/ppsz.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">2. PPSZ-41 "PEPESZA"</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/bren.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">3. BREN MK3</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/mosin.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">4. TOKARIEW IT</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/luger.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">5. P08 "LUGER"</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/mg42.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">6. MG42 2WŚ</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/thompson.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white text-center">7. THOMPSON 2WŚ</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/lee.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">8. FN FAL (L2A1, SLR)</h6>
                                        <div className="hline" />
                                        <p>
                            ...
                            <div className="col">
                                <div className="card WP">
                                    <img src={require('./img/m16a1.jpg')} className="card-img-top c_Photo" alt="..." />
                                    <div className="card-body bg-dark">
                                        <h6 className="card-title text-white">9. SWD "DRAGUNOW"</h6>
                                        <div className="hline" />
                                        <p>
...
export default Bron_historyczna